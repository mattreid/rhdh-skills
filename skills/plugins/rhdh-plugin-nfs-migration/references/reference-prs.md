...
| intelligent-assistant | [#2721](https://github.com/redhat-developer/rhdh-plugins/pull/2721) | Drawer + FAB using RHDH-specific blueprints (migrated from legacy `lightspeed` workspace) | Medium — RHDH-specific extensions (AppDrawerContent + AppRootElement) |
