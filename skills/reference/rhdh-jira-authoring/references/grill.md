...
| **Affects Version** | RHDHBUGS Bugs only. Infer from which RHDH release exhibits the defect (Build Details, prerequisites, "seen on 1.10"). **Required at create** — confirm before the write gate. Not Fix Version. |
...
- Are all required fields for New status determined? (Assignee, Priority, Team, Component — varies by type; RHDHBUGS Bug also needs Affects Version at create)
